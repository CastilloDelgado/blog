            ...
            <div class="flex justify-center gap-2 flex-wrap mb-8" >
                <form @submit.prevent="submit">
                    ...
                    <div class="mb-6">
                        ...
                        <UploadImage v-if="post.image_url" :image="post.image_url" /> 
                    </div>
                    <div class="mb-5">
                        <div class="flex mb-2">
                        ...
                        <div class="flex flex-wrap">
                            <UploadImage v-for="postImage in post.images" :image="postImage.image_url" />
                        </div>
                    </div>
                    <CustomButton type="submit" class="bg-primary-600 hover:bg-primary-800 text-primary-100 w-full" title="Editar Post!" />
                </form>
            </div>
        </div>
    </AdminLayout>
