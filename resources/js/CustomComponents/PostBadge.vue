...
<template>
    <Link :href="`/posts/${post.id}`" class="hover:scale-[101%] transition rounded-lg">
        <div class="w-80 mb-6 transition rounded-md h-full grid grid-cols-1 content-between" >
            <div class="rounded-lg">
                ...
                <div class="flex justify-center flex-col p-4">
                    ...
                    <div class="font-sans text-xs text-primary-950 mb-2">
                        <div class="mr-1 flex">
